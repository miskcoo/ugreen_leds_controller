...
License:        GPLv2
URL:            https://github.com/miskcoo/ugreen_dx4600_leds_controller

# Sources.
#tar -czf ugreen_dx4600_leds_controller.tar.gz ugreen_dx4600_leds_controller
...
%description
This package provides the %{kmod_name} kernel module(s) for ugreen_dx4600_leds_controller.
...
%{__install} -m 0644 ugreen-led.conf %{buildroot}/etc/modules-load.d/
